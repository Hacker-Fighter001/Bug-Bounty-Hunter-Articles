...
## Contents 
 ...
 - [Clickjacking (UI redressing attack)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Clickjacking-(UI-redressing-attack))
 - [CORS related issues](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#CORS-related-issues)
 - [Server Side Request Forgery (SSRF)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Server-Side-Request-Forgery-(SSRF))
 - [Local File Inclusion (LFI)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Local-File-Inclusion-(LFI))
 - [SQL Injection(SQLI)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#SQL-Injection(SQLI))
 - [Remote Code Execution (RCE)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Remote-Code-Execution (RCE))
 - [Subdomain Takeover](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Subdomain-Takeover)
 - [Race Condition](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Race-Condition)
 - [Denial of Service (DOS)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Denial-Service-(DOS))
 - [Authentication Bypass](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Authentication-Bypass)
 - [Insecure Direct Object Reference (IDOR)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Insecure-Direct-Object-Reference-(IDOR))
 - [2FA related issues](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#2FA-related-issues)
 - [Buffer Overflow Writeups](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Buffer-Overflow-Writeups)
 - [Android Pentesting](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Android-Pentesting)
 - [Cross Site Scripting (XSS)](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#cross-site-scripting-xss)
 - [Internet of Vehicles Test](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Internet-of-Vehicles-Test)
 - [Contributing](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Contributing)
 - [Maintainers](https://github.com/Hacker-Fighter001/BreadcrumbsBug-Bounty-Hunter-Articles#Maintainers)
